...
<div id="content">
   ...
   <div id="blogArticle" itemscope itemtype="http://schema.org/Article">
      <div class="articleHeader">
         <?php /*<h1 itemprop="headline"><?php echo $title; ?></h1>-->
      ...
      <?php if ($tags || $art_infoUpdate) { ?>
         <div class="tags-update">
            ...
            <?php if ($art_infoUpdate) { ?>
               <span class="updateInfo"><?php if ($art_infoName || $art_infoCategory || $art_infoDate || $art_infoComment) { ?>
            <span>
               <?php echo $art_infoName . $art_infoCategory . $art_infoDate; ?>
               <?php if ($art_infoName || $art_infoCategory || $art_infoDate) { ?>. <?php }?>
                <?php if ($art_infoComment) { ?><?php echo $comments; ?>.<?php }?>
            </span><span>|</span>
         <?php }?><?php echo $text_update ?> <span itemprop="dateModified"><?php echo $modified; ?></span></span>
            <?php } ?>
         </div>
      <?php } ?>      
                  ...
                  <?php if ($prodRelated['status']==1) { ?>
                     <div>
                        <div class="ihover">
                           ...
                           <div class="image"><a href="<?php echo $prodRelated['href']; ?>"><img class="image" src="<?php echo $prodRelated['thumb']; ?>" alt="<?php echo $prodRelated['name']; ?>" /></a></div>
                        <?php } ?>
												</div>
                        ...
                        <?php if ($prodRelated['rating']) { ?>
												  <div class="rating"><img src="catalog/view/theme/agnes/image/layout/stars_bottons/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $prodRelated['reviews']; ?>" /></div>
                        <?php } ?>
...
<?php if ($socMedia) { ?>
   ...
   <script type="text/javascript" src="//s7.addthis.com/js/250/addthis_widget.js<?php if($pubID) { echo '#pubid=' . $pubID; } ?>"></script>
<?php } ?>
<?php if ($commentStatus) { ?>
