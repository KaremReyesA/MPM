<?php echo $header; ?>
  <div class="other-breadcrumb">
    <?php if (isset($this->request->get['category_id']) && $this->request->get['category_id']) { ?>
      <h1><?php echo $heading_title; ?></h1><span class="livemarks"><a href="<?php echo $feedLink; ?>/category&category_id=<?php echo $this->request->get['category_id']; ?>" target="_blank" title="<?php echo $heading_title; ?> Feed"></a></span>
   <?php } else { ?>
      <h1><?php echo $heading_title; ?></h1><span class="livemarks"><a href="<?php echo $feedLink; ?>" target="_blank" title="<?php echo $heading_title; ?> Feed"></a></span>
   <?php } ?>
            ...
            <div class="articleCat" itemscope itemtype="http://schema.org/Article">
               <div class="articleContent">
                  <?php if ($article['image']) { ?>
                     <a class="imageFeaturedLink" href="<?php echo $article['readmore']; ?>" title="<?php echo $article['title']; ?>" itemprop="url" <?php /*style="height:<?php echo $article['image_height'] + 25; ?>px;"*/ ?>>
								<img class="imageFeatured" style="width: 100%; height: auto;" src="<?php echo $article['image']; ?>" alt="<?php echo $article['title']; ?>" itemprop="image" />
							</a>
                  <?php } ?>
