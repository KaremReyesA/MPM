...
<div id="content"><?php echo $content_top; ?>
  <div id="tabs" class="htabs">
    <a href="#tab-info" style="font-size: 22px;">+</a>
  ...
  <div class="product-info">
    ...
    <div class="right">
      <div class="description">
        <?php if ($manufacturer) { ?>
        <?php echo $text_manufacturer; ?> <span><a href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?></a></span><br />
        <?php } ?>
        <?php echo $text_model; ?> <span><?php echo $model; ?></span><br />
        <?php if ($reward) { ?>
        <?php echo $text_reward; ?> <span><?php echo $reward; ?></span><br />
        <?php } ?>
        <?php echo $text_stock; ?> <span><?php echo $stock; ?></span></div>
      <?php if ($price) { ?>
      <div class="price"><?php echo $text_price; ?>
        <?php if (!$special) { ?>
        <span class="other-price"><?php echo $price; ?></span>
        <?php } else { ?>
      ...
      <div class="options">
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo $option['name']; ?>:</b><br />
          <textarea style="width: 96%;" name="option[<?php echo $option['product_option_id']; ?>]" cols="40" rows="5"><?php echo $option['option_value']; ?></textarea>
        </div>
        <br />
        <?php } ?>
      ...
      <?php } ?>
      <div class="cart">
        <div style="padding-top: 5px;font-size: 13px;"><?php echo $text_qty; ?>
          <input type="text" name="quantity" size="2" value="<?php echo $minimum; ?>" class="new-quantity" />
          <input type="hidden" name="product_id" size="2" value="<?php echo $product_id; ?>" />
        </div>
        <div>
          <input type="button" value="<?php echo $button_cart; ?>" id="button-cart" class="cart-button" />
        </div>
        <div>
        <div class="ore"><p>&nbsp;&nbsp;&nbsp;<?php echo $text_or; ?>&nbsp;&nbsp;&nbsp;</p></div>
        <div class="add-box"><a onclick="addToWishList('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></a><br />
      ...
      <?php if ($review_status) { ?>
      <div class="review">
        <span><img src="catalog/view/theme/agnes/image/layout/stars_bottons/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /></span>&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;<a style="cursor: auto; color: #E7E7E7;">|</a>&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a>
